#!/usr/bin/env python3
"""Hemming Ch4 - Chamber Design Topics"""
...
ax.set_title('Hemming Ch4 - Chamber Performance')
ax.legend(); ax.grid(True, alpha=0.3)
plt.savefig(f'{OUT}/hemming_ch04_chamber_design.png', dpi=150, bbox_inches='tight')
plt.close()
print(f"Ch4 done")
