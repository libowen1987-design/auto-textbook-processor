...
### 主要内容
讨论载流导体在磁场中受到的力——**安培力**：$d\mathbf{F} = \mathbf{j}\times\mathbf{B}\, dV/c$。运动导体切割磁力线会产生**感应电动势**。

### 关键概念
- **导体在磁场中的力平衡**：电流密度$\mathbf{j}$、磁感应强度$\mathbf{B}$和力之间的相互关系
- **霍尔效应**：垂直于电流和磁场的方向产生霍尔电场，霍尔系数$R_H$反映载流子类型和浓度
- **磁流体动力学(MHD)**：导电流体在磁场中的行为

### 应用
电动马达、发电机、霍尔传感器、磁流体发电。
