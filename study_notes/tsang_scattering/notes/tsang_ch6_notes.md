...
> **第六章：粗糙面散射的积分方程**。研究粗糙面散射的积分方程方法，包括不可穿透介质的散射、标量波散射、电磁波在完美导体上的散射、电介质表面的积分方程、稀疏分布粗糙面的2D散射、有耗电介质表面的PBTG方法、基于切向表面场的四个Stokes参数，以及SMCG在Beowulf集群上的并行实现。**
