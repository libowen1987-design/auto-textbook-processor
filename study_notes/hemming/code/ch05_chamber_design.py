#!/usr/bin/env python3
"""Hemming Ch5 - Chamber Design Topics"""
...
ax.set_title('Hemming Ch5 - Chamber Performance')
ax.legend(); ax.grid(True, alpha=0.3)
plt.savefig(f'{OUT}/hemming_ch05_chamber_design.png', dpi=150, bbox_inches='tight')
plt.close()
print(f"Ch5 done")
