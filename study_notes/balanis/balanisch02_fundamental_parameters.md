...
## 2.11 Friis Transmission Equation（Friis 传输方程）
...
## 2.12 Radar Range Equation（雷达方程）
...
## 2.13 Antenna Noise Temperature（天线噪声温度）
