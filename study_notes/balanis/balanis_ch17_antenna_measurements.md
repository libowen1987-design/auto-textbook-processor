# Balanis Ch17 — Antenna Measurements (天线测量)

> **Balanis 4th Edition, Chapter 17 | 天线测量 — 理论、方法与误差分析**
...
## §17.3 Radiation Pattern Measurement (方向图测量)
...
## §17.5 Directivity Measurement (方向性测量)
...
## §17.6 Polarization Measurement (极化测量)
...
## §17.7 Impedance Measurement (阻抗测量)
...
## §17.8 Efficiency Measurement (效率测量)
...
## §17.9 Mutual Coupling Measurement (互耦测量)
...
## §17.10 Scale Model Measurements (缩比模型测量)
