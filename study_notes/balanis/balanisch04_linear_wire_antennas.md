...
## 4.2 Infinitesimal Dipole（无穷小偶极子）
...
## 4.4 Finite-Length Dipole（有限长偶极子）
...
## 4.5 Half-Wavelength Dipole（半波偶极子）
...
## 4.6 Practical Dipole Antennas（实用偶极子天线）

### 4.6.1 Folded Dipole（折合偶极子）

由两个平行的 λ/2 偶极子在端部连接构成。
