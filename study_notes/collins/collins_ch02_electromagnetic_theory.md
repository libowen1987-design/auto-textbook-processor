...
$$
where $\bar{\bar{\varepsilon}}$ and $\bar{\bar{\mu}}$ are permittivity and permeability tensors (3×3 matrices). Ferrites under DC magnetic bias exhibit **gyromagnetic** behavior (§2.2, p. 27).
