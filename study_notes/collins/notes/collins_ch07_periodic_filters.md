---
title: Chapter 7: Periodic Structures and Microwave Filters / 第7章：周期性结构与微波滤波器
source: Collin, Foundations for Microwave Engineering, 2nd Ed., Ch.8 (§8.1–§8.23), pp. 550–647.
---

# Chapter 7: Periodic Structures and Microwave Filters
# 第7章：周期性结构与微波滤波器（Periodic Structures and Microwave Filters）
...
### 7.1.3 k-\beta 图 (k-\beta Diagram, p. 564)

k-\beta 图 (或 Brillouin 图) 显示频率与相位常数之间的关系。对于电容加载传输线:
...
| 章节 | 主题 | 关键公式/概念 |
|------|------|--------------|
| §7.1 | 周期结构 | Floquet 定理, $\cosh \gamma d = (A+D)/2$, k-\beta 图, 通带/阻带 |
