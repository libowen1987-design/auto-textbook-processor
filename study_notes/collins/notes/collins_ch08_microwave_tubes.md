---
title: Chapter 8: Microwave Tubes / 第8章：微波管
source: Collin, Foundations for Microwave Engineering, 2nd Ed., Ch.9 (§9.1–§9.13), pp. 648–712.
---

# Chapter 8: Microwave Tubes
# 第8章：微波管（Microwave Tubes）
...
电场径向($E_r$),磁场轴向($B_z$),电子在 **E \times B** 方向漂移,形成围绕阴极旋转的电子云。
