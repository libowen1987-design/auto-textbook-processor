...
> 郭硕鸿《电动力学》第3版（高教社 ISBN 7-04-023924-8，2008）
...
其中 $\varepsilon_0 \approx 8.854 \times 10^{-12}\,\text{F/m}$ 为真空介电常数。
...
$$
\oint_C \vec{E} \cdot \mathrm{d}\vec{l} = -\frac{\mathrm{d}}{\mathrm{d}t} \int_S \vec{B} \cdot \mathrm{d}\vec{S}
$$
...
$$
\vec{J} \cdot \vec{E} = -\frac{\partial}{\partial t}\left(\frac{1}{2}\varepsilon_0 E^2 + \frac{1}{2}\frac{B^2}{\mu_0}\right) - \nabla \cdot (\vec{E} \times \vec{H})
$$
...
$$
-\frac{\mathrm{d}}{\mathrm{d}t} \int_V w \,\mathrm{d}V = \oint_S \vec{S} \cdot \mathrm{d}\vec{S} + \int_V \vec{J} \cdot \vec{E} \,\mathrm{d}V
$$
