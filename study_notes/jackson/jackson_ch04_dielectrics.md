# Jackson《Classical Electrodynamics》Ch4 — Multipoles, Macroscopic Media, Dielectrics

> **Sections:** §4.1–§4.9 | **Book:** John David Jackson, 3rd Ed, Wiley 1999

---

## 4.1 — 4.2: Multipole Expansion

### Goal: approximate $\Phi(\mathbf{x})$ for a localized charge distribution at large distances
...
### Taylor expansion of $1/|\mathbf{x} - \mathbf{x}'|$
...
### Dipole moment is origin-dependent unless $Q = 0$
...
## 4.5: Quadrupole Moment

### Quadrupole tensor (traceless)
...
### Multipole moments in spherical form
...
## 4.7: Energy and Force in Multipole Expansion

### Energy of charge distribution in external potential

$$
W = \int \rho(\mathbf{x}) \Phi_{\text{ext}}(\mathbf{x}) \, d^3x
$$

### Multipole expansion of energy
...
### Force on multipole in external field
...
## 4.8: Dielectrics — Macroscopic Description
...
## 4.9: Boundary-Value Problems with Dielectrics

### Dielectric sphere in uniform external field $\mathbf{E}_0$
...
### Dielectric cylinder in uniform transverse field
