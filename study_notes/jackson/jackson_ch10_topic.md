...
## 2. 散射基本理论 (Fundamentals of Scattering)

### 2.1 散射振幅与截面 (Scattering Amplitude and Cross Section)
...
### 2.2 散射的矢势公式 (Vector Potential Formulation)
...
### 3.1 电偶极散射 (Electric Dipole Scattering)
...
### 3.2 随机介质中的散射 (Scattering in Random Media)
...
### 4.1 散射系数 (Scattering Coefficients $a_l, b_l$)
...
## 5. 夫琅禾费衍射 (Fraunhofer Diffraction)
...
## 7. 基尔霍夫衍射理论 (Kirchhoff Diffraction Theory)

Rigorous scalar diffraction theory using Green's theorem:

$$
U(P) = \frac{1}{4\pi} \iint_S \left[U \frac{\partial G}{\partial n} - G \frac{\partial U}{\partial n}\right] dS
$$
