# Chapter 9: Radiating Systems, Multipole Fields and Radiation / 辐射系统、多极场与辐射

> Jackson *Classical Electrodynamics*, 3rd Ed, §9.1–9.14

---

## 1. Overview — Why Multipoles Matter / 概述——为什么需要多极展开
...
## 2. 时谐场中的矢势 (Vector Potential for Time-Harmonic Fields) / 时谐场中的矢势 (Vector Potential for Time—Harmonic Fields)
...
## 3. 远场近似 (Far-Field Approximation) / 远场近似 (Far—Field Approximation)
...
## 4. 多极展开 (Multipole Expansion) / 多极展开 (Multipole Expansion)
...
### 4.1 Electric Dipole Term (Leading Order) / 4.1 Electric Dipole Term (Leading Order)
...
### 4.2 Magnetic Dipole Term / 4.2 Magnetic Dipole Term
...
### 4.3 Electric Quadrupole Term / 4.3 Electric Quadrupole Term
...
## 5. 天线的辐射 (Radiation from Antennas) / 天线的辐射 (Radiation from Antennas)
...
### 5.2 半波偶极子 (Half-Wave Dipole $l = \lambda/2$) / 5.2 半波偶极子 (Half—Wave Dipole $l = \lambda/2$)
...
### 5.3 天线阵列 (Antenna Arrays) / 5.3 天线阵列 (Antenna Arrays)
...
## 6. 球谐展开 (Spherical Harmonic Expansion) / 球谐展开 (Spherical Harmonic Expansion)
...
## 7. 重要公式速查 (Key Formulas Cheat Sheet) / 重要公式速查 (Key Formulas Cheat Sheet)
...
## 8. 物理直觉 (Physical Intuition) / 物理直觉 (Physical Intuition)
