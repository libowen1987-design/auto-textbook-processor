# Jackson《Classical Electrodynamics》Ch3 — Boundary-Value Problems in Electrostatics II / 静电学边界值问题 II

> **Sections:** §3.1–§3.13 | **Book:** John David Jackson, 3rd Ed, Wiley 1999

---

## Laplace Equation in Spherical Coordinates — Legendre Expansions / 球坐标中的拉普拉斯方程——勒让德展开

### Azimuthal symmetry ($m = 0$) / Azimuthal symmetry ($m = 0$)
...
### Example: Conducting sphere of radius $a$ in uniform field $E_0 \hat{\mathbf{z}}$ / Example: Conducting sphere of radius $a$ in uniform field $E_0 \hat{\mathbf{z}}$
...
### Example: Charged ring on sphere / Example: Charged ring on sphere
...
## Legendre Expansion of Coulomb Potential / 库仑势的勒让德展开

### Very useful expansion / Very useful expansion
...
## Cylindrical Coordinates & Bessel Functions / Cylindrical Coordinates与Bessel Functions
...
### Asymptotic forms / Asymptotic forms
...
## Cylindrical Boundary Value Problems / Cylindrical Boundary Value Problems

### Example: Potential inside a grounded cylinder with top at $V(\rho,\phi)$ / Example: Potential inside a grounded cylinder with top at $V(\rho,\phi)$
...
### Example: Dielectric cylinder in uniform field / Example: Dielectric cylinder in uniform field
...
## Spherical Harmonics — General $m$ / Spherical Harmonics——General $m$
...
### Orthogonality and completeness / Orthogonality与completeness
...
### Expansion of $1/|\mathbf{x} - \mathbf{x}'|$ — full form / Expansion of $1/|\mathbf{x} — \mathbf{x}'|$——full form
...
## Green Function for Cylindrical Coordinates / 柱坐标格林函数

### Dirichlet Green function inside a cylinder (radius $a$) / Dirichlet Green function inside a cylinder (radius $a$)
...
## Eigenfunction Method for Poisson's Equation / 泊松方程的本征函数法
...
### Green function via eigenfunctions / Green function via eigenfunctions
