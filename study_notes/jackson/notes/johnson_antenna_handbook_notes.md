...
7. Part 6: Structures与Materials (Ch36—45)(#7-part-6-structures--materials-ch36-45)
...
### 1.1 与 Balanis 教材定位差异 / 1.1 与 Balanis 教材定位差异
...
### Ch 1: 天线基础 (Antenna Fundamentals) / Ch 1: 天线基础 (Antenna Fundamentals)
...
### Ch 2: 方向图与方向性 (Radiation Patterns & Directivity) / Ch 2: 方向图与方向性 (Radiation Patterns与Directivity)
...
### Ch 3: 阻抗与带宽 (Impedance & Bandwidth) / Ch 3: 阻抗与带宽 (Impedance与Bandwidth)
...
### Ch 4: 极化 (Polarization) / Ch 4: 极化 (Polarization)
...
### Ch 5: 天线测量 (Antenna Measurement) / Ch 5: 天线测量 (Antenna Measurement)
...
### Ch 6: 偶极子天线 (Dipole Antennas) / Ch 6: 偶极子天线 (Dipole Antennas)
...
### Ch 7: 环形天线 (Loop Antennas) / Ch 7: 环形天线 (Loop Antennas)
...
### Ch 8: 螺旋天线 (Helical Antennas) / Ch 8: 螺旋天线 (Helical Antennas)
...
### Ch 10: 对数周期天线 (Log-Periodic Antennas) / Ch 10: 对数周期天线 (Log—Periodic Antennas)
...
### Ch 11: 喇叭天线 (Horn Antennas) / Ch 11: 喇叭天线 (Horn Antennas)
...
### Ch 12: 反射面天线 (Reflector Antennas) / Ch 12: 反射面天线 (Reflector Antennas)
...
### Ch 13: 透镜天线 (Lens Antennas) / Ch 13: 透镜天线 (Lens Antennas)
...
### Ch 14: 微带天线 (Microstrip Antennas) / Ch 14: 微带天线 (Microstrip Antennas)

#### 核心理论和公式

**矩形贴片**
- 谐振长度近似：$\Delta L = 0.412h \frac{\epsilon_{eff} + 0.3}{\epsilon_{eff} - 0.258} \cdot \frac{W/h + 0.264}{W/h + 0.8}$
- 有效介电常数：$\epsilon_{eff} = \frac{\epsilon_r + 1}{2} + \frac{\epsilon_r - 1}{2}\left1 + 12\frac{h}{W}\right^{-1/2}$
...
### Ch 15: 缝隙天线 (Slot Antennas) / Ch 15: 缝隙天线 (Slot Antennas)
...
### Ch 16: 喇叭与反射面阵列馈源 (Horn & Reflector Array Feeds) / Ch 16: 喇叭与反射面阵列馈源 (Horn与Reflector Array Feeds)

#### 核心内容
- 多喇叭馈源（跟踪馈源）
- 单脉冲馈源系统（Σ/\Delta 和差网络）
- 波束波导馈电
- 馈源阵列（多波束反射面）
...
### Ch 17: 线阵 (Linear Arrays) / Ch 17: 线阵 (Linear Arrays)
...
### Ch 18: 面阵 (Planar Arrays) / Ch 18: 面阵 (Planar Arrays)
...
### Ch 19: 相控阵 (Phased Arrays) / Ch 19: 相控阵 (Phased Arrays)
...
### Ch 20: 自适应阵 (Adaptive Arrays) / Ch 20: 自适应阵 (Adaptive Arrays)
...
### Ch 21: 随机阵与统计阵 (Random & Statistical Arrays) / Ch 21: 随机阵与统计阵 (Random与Statistical Arrays)
...
### Ch 22: 阵列馈电网络 (Array Feed Networks) / Ch 22: 阵列馈电网络 (Array Feed Networks)
...
### Ch 24: 地面通信天线 (Earth Station Antennas) / Ch 24: 地面通信天线 (Earth Station Antennas)
...
### Ch 25: 航天器天线 (Spacecraft Antennas) / Ch 25: 航天器天线 (Spacecraft Antennas)
...
### Ch 26: 手机与移动通信天线 (Land-Mobile Antennas) / Ch 26: 手机与移动通信天线 (Land—Mobile Antennas)
...
### Ch 27: 通信与广播发射天线 (Communication & Broadcast Transmitting Antennas) / Ch 27: 通信与广播发射天线 (Communication与Broadcast Transmitting Antennas)
...
### Ch 28: 雷达天线 (Radar Antennas) / Ch 28: 雷达天线 (Radar Antennas)
...
### Ch 29: 电子战与对抗天线 (Electromagnetic Warfare Antennas) / Ch 29: 电子战与对抗天线 (Electromagnetic Warfare Antennas)
...
### Ch 30: 探地雷达与穿墙雷达 (GPR & Through-Wall) / Ch 30: 探地雷达与穿墙雷达 (GPR与Through—Wall)
...
### Ch 31: 超宽带天线 (Ultra-Wideband Antennas) / Ch 31: 超宽带天线 (Ultra—Wideband Antennas)
...
### Ch 32-35: 其他特殊天线 / Ch 32—35: 其他特殊天线
...
## 7. Part 6: Structures & Materials (Ch36-45) / 7. Part 6: Structures与Materials (Ch36—45)

### Ch 36-37: 天线罩 (Radomes) / Ch 36—37: 天线罩 (Radomes)
...
### Ch 38: 塔架与支撑结构 (Towers & Supports) / Ch 38: 塔架与支撑结构 (Towers与Supports)
...
### Ch 39: 天线安装 (Antenna Installation) / Ch 39: 天线安装 (Antenna Installation)
...
### Ch 40-45: 材料与结构工程 / Ch 40—45: 材料与结构工程
...
### Ch 46: 波导数据 (Waveguide Data) / Ch 46: 波导数据 (Waveguide Data)
...
### Ch 47: 传输线与馈电 (Transmission Lines & Feed Systems) / Ch 47: 传输线与馈电 (Transmission Lines与Feed Systems)
...
### Ch 48: 阻抗匹配网络 (Impedance Matching Networks) / Ch 48: 阻抗匹配网络 (Impedance Matching Networks)
...
### Ch 49: 史密斯圆图 (Smith Chart) / Ch 49: 史密斯圆图 (Smith Chart)
...
### Ch 50: 天线开关与旋转关节 (Switches & Rotary Joints) / Ch 50: 天线开关与旋转关节 (Switches与Rotary Joints)
...
### Ch 51: 平衡-不平衡转换器 (Baluns) / Ch 51: 平衡—不平衡转换器 (Baluns)
...
### Ch 52: 天线测试设施 (Antenna Test Facilities) / Ch 52: 天线测试设施 (Antenna Test Facilities)
...
## 9. 工程设计数据速查表 / 工程设计数据速查表

### 9.1 常见天线类型性能对比 / 9.1 常见天线类型性能对比
...
### Johnson vs. Balanis 章节对应表 / Johnson vs. Balanis 章节对应表
...
### 初学者路径（与Balanis配合） / 初学者路径（与Balanis配合）
```
