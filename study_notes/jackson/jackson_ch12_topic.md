...
## 2. 相对论运动方程 (Relativistic Equation of Motion)

### 2.1 洛伦兹力方程 (Lorentz Force Equation)
...
### 2.2 匀速电场中的运动 (Uniform Electric Field E $\parallel$ x)
...
### 2.3 匀速磁场中的运动 (Uniform Magnetic Field)
...
### 2.4 交叉电磁场中的运动 (Crossed E $\perp$ B)
...
## 3. 拉格朗日量与哈密顿量 (Lagrangian and Hamiltonian)

### 3.1 相对论点粒子的拉格朗日量 (Relativistic Lagrangian)
...
## 4. 辐射反作用力 (Radiation Reaction / Self-Force)

### 4.1 问题的提出 (The Problem)
...
### 4.2 狄拉克的推导 (Dirac's Derivation, 1938)
...
### 4.3 非相对论极限：AL方程 (Non-relativistic Limit: Abraham-Lorentz)
...
### 4.4 预加速与逃逸解 (Pre-acceleration and Runaway Solutions)
...
### 4.5 辐射阻尼的近似处理 (Approximate Treatment: Landau-Lifshitz)
...
## 6. 康普顿散射 (Compton Scattering)

### 6.1 汤姆孙散射回顾 (Thomson Scattering, Classical)
...
### 6.2 康普顿散射 (Quantum: Klein-Nishina)
...
### 6.3 逆康普顿散射 (Inverse Compton Scattering)
...
## 7. 散射矩阵与量子电动力学 (S-Matrix and QED)

### 7.1 最小耦合与费曼规则 (Minimal Coupling and Feynman Rules)
...
### 7.2 电子-电子散射：Møller散射 (Møller Scattering)**
$e^- e^- \to e^- e^-$
...
### 7.3 电子-正电子散射：Bhabha散射 (Bhabha Scattering)**
$e^+ e^- \to e^+ e^-$

---

## 8. 重要公式速查 (Key Formulas Cheat Sheet)
